...
<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - September22, 2014!</div>
  <div class="container_12">
    ...
    <div class="grid_3">
      <div class="banner-1">
        <div class="maxheight">
          <img src="assets/images/page4_img1.jpg" alt="">
    ...
    <div class="grid_3">
      <div class="banner-1">
        <div class="maxheight">
          <img src="assets/images/page4_img2.jpg" alt="">
          <div class="banner-1_bot">
    ...
    <div class="grid_3">
      <div class="banner-1">
        <div class="maxheight">
          <img src="assets/images/page4_img3.jpg" alt="">
          <div class="banner-1_bot">
    ...
    <div class="grid_3">
      <div class="banner-1">
        <div class="maxheight">
          <img src="assets/images/page4_img4.jpg" alt="">
          <div class="banner-1_bot">
  ...
  <article class="block-1 white">
    <div class="container_12">
      <div class="grid_8">
        ...
        <img src="assets/images/page4_img5.jpg"  alt="" class="img_inner fleft offset__2">
      ...
      <div class="grid_4">
        <div class="banner-2"><img src="assets/images/page4_img6.jpg" alt="">
